...
mpc.gencost = [
	...
	%2	 0.0	 0.0	 3	   0.085000	   1.200000	   0.000000; %new line
...
%column_names%	rate_i	rate_p λimax imax
mpc.branch_limit = [
	50.2	45 1.6 40;
	36	60.1	1.6 50;
	12	30	1.6 	25;
...
%column_names% number string λvmin λvmax
mpc.bus_data = {
	 1	'FAV SPOT 02'    1.6    1.6;
	 2	'FAV PLACE 05'   1.6    1.6;
	 3	'FAV PLC 08'     1.6    1.6;
};
...
%column_names% distribution deg Nrec Beta alpha beta load pd_unc qd_unc
mpc.dist = {
    'Uniform01OrthoPoly'    1   5       0   0   0       1   1    1
    'Uniform01OrthoPoly'    1   5       0   0   0       2   1    1
    'Uniform01OrthoPoly'    1   5       0   0   0       3   1    1
	'Beta01OrthoPoly'		1	5		1	4	3		3	2	 2
};
