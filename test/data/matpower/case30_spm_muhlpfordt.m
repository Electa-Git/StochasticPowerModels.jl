...
mpc.bus_sdata = [
                0       0.0     0.0     1.03643 1.03643;
                1       21.7    3.255   1.03643 1.03643;
                1       2.4     0.36    1.03643 1.03643;
                2       7.6     1.14    1.03643 1.03643;
                0       94.2    0.0    	1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       22.8    0.0     1.03643 1.03643;
                0       30.0    0.0     1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                4       5.8     0.87    1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       11.2    0.0     1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       6.2     0.0     1.03643 1.03643;
                0       8.2     0.0     1.03643 1.03643;
                0       3.5     0.0     1.03643 1.03643;
                0       9.0     0.0     1.03643 1.03643;
                0       3.2     0.0     1.03643 1.03643;
                0       9.5     0.0     1.03643 1.03643;
                0       2.2     0.0     1.03643 1.03643;
                4       17.5    2.625   1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       3.2     0.0     1.03643 1.03643;
                3       8.7     1.305   1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       3.5     0.0     1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       0.0     0.0     1.03643 1.03643;
                0       2.4     0.0     1.03643 1.03643;
                0       10.6    0.0     1.03643 1.03643;
]

%% generator data
%	bus     Pg	    Qg      Qmax    Qmin    Vg      mBase   status  Pmax    Pmin
mpc.gen = [
	1	    135.5	5.0	    10.0	0.0	    1.0	    100.0	1	    271.0	0.0; % NG
	2	    46.0	3.0	    46.0	-40.0	1.0	    100.0	1	    92.0	0.0; % NG
	5	    0.0	    0.0	    40.0	-40.0	1.0	    100.0	1	    0.0	    0.0; % SYNC
	8	    0.0	    15.0	40.0	-10.0	1.0	    100.0	1	    0.0	    0.0; % SYNC
	11	    0.0	    9.0	    24.0	-6.0	1.0	    100.0	1	    0.0	    0.0; % SYNC
	13	    0.0	    9.0	    24.0	-6.0	1.0	    100.0	1	    0.0	    0.0; % SYNC
];

%% generator cost data
%	2       up	    down    n       c2      c1	    c0
mpc.gencost = [
	2	    0.0	    0.0	    3	    0.00000	18.4215	0.00000; % NG
	2	    0.0	    0.0	    3	    0.00000	52.1823	0.00000; % NG
	2	    0.0	    0.0	    3	    0.00000	0.00000	0.00000; % SYNC
	2	    0.0	    0.0	    3	    0.00000	0.00000	0.00000; % SYNC
	2	    0.0	    0.0	    3	    0.00000	0.00000	0.00000; % SYNC
	2	    0.0	    0.0	    3	    0.00000	0.00000	0.00000; % SYNC
];
...
mpc.branch = [
	1	    2	    0.0192	0.0575	0.0		138	    138	    138	    0.0	    0.0	    1	    -30.0   30.0;
	1	    3	    0.0452	0.1652	0.0		152	    152	    152	    0.0	    0.0	    1	    -30.0	30.0;
	2	    4	    0.057	0.1737	0.0		139	    139	    139	    0.0	    0.0	    1	    -30.0	30.0;
	3	    4	    0.0132	0.0379	0.0		135	    135	    135	    0.0	    0.0	    1	    -30.0	30.0;
	2	    5	    0.0472	0.1983	0.0		144	    144	    144	    0.0	    0.0	    1	    -30.0	30.0;
	2	    6	    0.0581	0.1763	0.0		139	    139	    139	    0.0	    0.0	    1	    -30.0	30.0;
	4	    6	    0.0119	0.0414	0.0		148	    148	    148	    0.0	    0.0	    1	    -30.0	30.0;
	5	    7	    0.046	0.116	0.0		127	    127	    127	    0.0	    0.0	    1	    -30.0	30.0;
	6	    7	    0.0267	0.082	0.0		140	    140	    140	    0.0	    0.0	    1	    -30.0	30.0;
	6	    8	    0.012	0.042	0.0		148	    148	    148	    0.0	    0.0	    1	    -30.0	30.0;
	...
	15	    23	    0.1	    0.202	0.0	    19.9375	29	    29	    0.0	    0.0	    1	    -30.0	30.0;
	...
	25	    27	    0.1093	0.2087	0.0	    21.0	28	    28	    0.0	    0.0	    1	    -30.0	30.0;
	...
	8	    28	    0.0636	0.2	    0.0		140	    140	    140	    0.0	    0.0	    1	    -30.0	30.0;
	6	    28	    0.0169	0.0599	0.0		149	    149	    149	    0.0	    0.0	    1	    -30.0	30.0;
];
